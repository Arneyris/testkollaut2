 ...
 *  НАСТРОЙКИ
 *  ========================= */
const MAP_SRC = "/maps/mirage_map.jpg";  // твой файл карты
  ...
  return (
    <main className="bg-black text-white min-h-screen p-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        >
          <img src={MAP_SRC} alt="Mirage map" className="block w-full h-auto select-none pointer-events-none" draggable={false} />
